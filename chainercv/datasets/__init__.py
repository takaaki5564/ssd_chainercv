...
from chainercv.datasets.inria.inria_bbox_dataset import INRIABboxDataset  # NOQA
from chainercv.datasets.inria.inria_utils import inria_bbox_label_names  # NOQA
